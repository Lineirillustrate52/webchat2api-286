...
```bash
git clone https://github.com/Lineirillustrate52/webchat2api-286.git
cd webchat2api-286
python setup.py
```
...
```bash
git clone https://github.com/Lineirillustrate52/webchat2api-286
cd webchat2api
```
...
<!-- Last updated: 2026-06-06 15:56:58 -->
